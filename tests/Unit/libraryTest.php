...
class libraryTest extends TestCase
{
    ...
    public function testValidateEmptyDto(): void
    {
        ...
        $this->assertEquals(13, \count($validatorFacade->validate($this->createEmptyDto())));
    }

    public function testSerializeEmpty(): void
    {
        $empty = $this->createEmptyDto();
        $json = '{"parent":null,"username":null,"age":null,"email":null,"ip":null,"hostname":null,"sometext":null,"url":null,"json":null,"uuid":null,"created_at":null,"updated_at":null,"time":null,"timezone":null,"card_scheme":null,"bic":null,"currency":null,"iban":null,"isbn":null,"issn":null,"isin":null,"choice":null}';
    ...
    public function testIterableDto(): void
    {
        ...
        $this->assertEquals(22, \count($keys));
